...
class Review(models.Model):
    ...
    order_product = models.OneToOneField('order.OrderProduct', verbose_name="주문-상품", related_name="review",
    ...
    is_honest = models.BooleanField(verbose_name="솔직리뷰", default=False)
