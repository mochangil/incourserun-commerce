...
class Product(models.Model):
    ...
    photo = models.ImageField(verbose_name="상품이미지", upload_to=None, null=True, blank=True)
    detail = models.ImageField(verbose_name="상세이미지", upload_to=None, null=True, blank=True)
